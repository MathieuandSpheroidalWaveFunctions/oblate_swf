...
if (warn) then
              ...
              if(ioprad.eq.2.and.li.lt.matlilim.and.ix.eq.1) nar(li-1)=naccrp
              if(ioprad.eq.2.and.li.lt.matlilim.and.ix.eq.1) nar(li)=naccr
              if(ioprad.eq.2.and.li.ge.matlilim) nar(li)=naccr
...
if (output) then
                ...
                if(iopang.eq.2) write(30,1470) barg(jarg),s1c(jarg),is1e(jarg),s1dc(jarg), &
